 ...
 * @author raunak
 */
public class WholesalerSalesPricingRequestJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private UserAccount userAccount;
    private WholesalerPricingOrganization wholesalerPricingOrganization;
    
    public WholesalerSalesPricingRequestJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        initComponents();
        
        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.wholesalerPricingOrganization = (WholesalerPricingOrganization) organization;
        populateTable();
     ...
     private void populateTable() {
        ...
        for (WorkRequest wr : wholesalerPricingOrganization.getWorkQueue().getWorkRequestList()) {
    ...
    private void btnRequestPricingChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestPricingChangeActionPerformed
        ...
        wholesalerPricingOrganization.getWorkQueue().getWorkRequestList().add(request);
        userAccount.getWorkQueue().getWorkRequestList().add(request);

        JOptionPane.showMessageDialog(this, "Price change request sent to Wholesaler Pricing Analyst.");
        populateTable();
