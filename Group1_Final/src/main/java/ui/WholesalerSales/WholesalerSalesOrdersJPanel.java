 ...
 */
public class WholesalerSalesOrdersJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private UserAccount userAccount;
    private WholesalerSalesOrganization wholesalerSalesOrganization;
    private Enterprise enterprise;

    public WholesalerSalesOrdersJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business, Enterprise enterprise) {
         this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.wholesalerSalesOrganization = (WholesalerSalesOrganization) organization;
    ...
    private void populateSalesDataTable() {
        ...
        if (business.getWholesalerMasterOrderList() != null) {
            for (WholesalerOrder order : business.getWholesalerMasterOrderList().getOrderList()) {
