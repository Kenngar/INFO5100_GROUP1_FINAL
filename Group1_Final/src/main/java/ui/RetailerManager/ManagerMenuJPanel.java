...
public class ManagerMenuJPanel extends javax.swing.JPanel {
    ...
    private void btnStoreViewInventoryIdentifyResourceAssetsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStoreViewInventoryIdentifyResourceAssetsActionPerformed
        ...
        ManagerInventoryJPanel storeManagerInventoryJPanel
                = new ManagerInventoryJPanel(
    ...
    private void btnContactShippingCompanyIdentifyResourceAssetsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContactShippingCompanyIdentifyResourceAssetsActionPerformed
        ...
        for (Organization org : targetEnterprise.getOrganizationDirectory().getOrganizationList()) {
            ...
            if (org.getName().equalsIgnoreCase("East Shipping Facility")) {
                ...
                ManagerToShippingRequest panel
                        = new ManagerToShippingRequest(userProcessContainer, userAccount, targetOrg, business);
    ...
    private void btnConfirmRequestsAssociatesIdentifyResourceAssetsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmRequestsAssociatesIdentifyResourceAssetsActionPerformed
        ...
        ManagerToAssociateRequest contactStoreAssociateWorkAreaJPanel
                = new ManagerToAssociateRequest(
                        userProcessContainer,
                        userAccount,
                        organization,
                        business
    ...
    private void btnContactShippingCompany1IdentifyResourceAssetsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContactShippingCompany1IdentifyResourceAssetsActionPerformed
        ...
        Enterprise targetEnterprise = business.getNetworkList().get(0).getEnterpriseDirectory().getEnterpriseList().stream().filter(e -> e.getName().equals("Dick's Sporting Goods")).findFirst().orElse(null);
        for (Organization org : targetEnterprise.getOrganizationDirectory().getOrganizationList()) {
            System.out.println("Checking org: " + org.getName()); // DEBUG
        ...
        ManagerToRetailBA managerToRetailBA =
        new ManagerToRetailBA(
         userProcessContainer,
         userAccount,
         targetOrg,
         business
        ...
        userProcessContainer.add("ManagerToRetailBA", managerToRetailBA);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
