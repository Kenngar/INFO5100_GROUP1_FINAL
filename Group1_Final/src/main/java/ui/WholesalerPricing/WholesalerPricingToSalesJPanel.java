 ...
 */
public class WholesalerPricingToSalesJPanel extends javax.swing.JPanel {
    ...
    public WholesalerPricingToSalesJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        initComponents();
