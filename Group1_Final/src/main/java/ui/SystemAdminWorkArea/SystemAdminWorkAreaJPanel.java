...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnManageAdmin1.setText("View Reports");
    ...
    private void btnManageAdmin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageAdmin1ActionPerformed
        ...
        ReportingJPanel reportingJPanel = new ReportingJPanel(userProcessContainer, ecosystem);
        userProcessContainer.add("reportingJPanel", reportingJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
